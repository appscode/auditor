...
var dashboardtemplatesResource = schema.GroupVersionResource{Group: "auditor.kubeshield.to", Version: "v1alpha1", Resource: "dashboardtemplates"}

var dashboardtemplatesKind = schema.GroupVersionKind{Group: "auditor.kubeshield.to", Version: "v1alpha1", Kind: "DashboardTemplate"}
