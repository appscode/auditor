...
var datasourcesResource = schema.GroupVersionResource{Group: "auditor.kubeshield.to", Version: "v1alpha1", Resource: "datasources"}

var datasourcesKind = schema.GroupVersionKind{Group: "auditor.kubeshield.to", Version: "v1alpha1", Kind: "Datasource"}
