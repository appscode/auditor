...
import (
	v1alpha1 "go.appscode.dev/auditor/client/clientset/versioned/typed/grafana/v1alpha1"
...
func (c *FakeGrafanaV1alpha1) DashboardTemplates(namespace string) v1alpha1.DashboardTemplateInterface {
