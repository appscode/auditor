...
// GrafanaV1alpha1Client is used to interact with features provided by the grafana.searchlight.dev group.
...
func (c *GrafanaV1alpha1Client) DashboardTemplates(namespace string) DashboardTemplateInterface {
