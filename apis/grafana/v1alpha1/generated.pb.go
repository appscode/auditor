...
// source: go.appscode.dev/auditor/apis/grafana/v1alpha1/generated.proto
...
func init() {
	proto.RegisterType((*Dashboard)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.Dashboard")
	proto.RegisterType((*DashboardList)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DashboardList")
	proto.RegisterType((*DashboardReference)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DashboardReference")
	proto.RegisterType((*DashboardSpec)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DashboardSpec")
	proto.RegisterType((*DashboardStatus)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DashboardStatus")
	proto.RegisterType((*DashboardTemplate)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DashboardTemplate")
	proto.RegisterType((*DashboardTemplateList)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DashboardTemplateList")
	proto.RegisterType((*DashboardTemplateReference)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DashboardTemplateReference")
	proto.RegisterType((*DashboardTemplateSpec)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DashboardTemplateSpec")
	proto.RegisterType((*Datasource)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.Datasource")
	proto.RegisterType((*DatasourceList)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DatasourceList")
	proto.RegisterType((*DatasourceSpec)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DatasourceSpec")
	proto.RegisterType((*DatasourceStatus)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.DatasourceStatus")
	proto.RegisterType((*TargetRef)(nil), "go.appscode.dev.grafana_operator.apis.grafana.v1alpha1.TargetRef")
}

func init() {
	proto.RegisterFile("go.appscode.dev/auditor/apis/grafana/v1alpha1/generated.proto", fileDescriptor_8444a24aaa89090c)
}
